...
@Component({
  selector: 'app-sidebar-reduced',
  templateUrl: './sidebar-reduced.component.html',
  styleUrls: ['./sidebar-reduced.component.css']
})
export class SidebarReducedComponent implements OnInit {
