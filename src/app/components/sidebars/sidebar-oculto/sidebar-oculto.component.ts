...
@Component({
  selector: 'app-sidebar-oculto',
  templateUrl: './sidebar-oculto.component.html',
  styleUrls: ['./sidebar-oculto.component.css']
})
export class SidebarOcultoComponent implements OnInit {
